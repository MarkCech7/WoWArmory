...
def get_arena_leaderboards_url(query: str) -> str:
    ...
    return f"{phrase}\nYou can visit leaderboards here: <a href=\"http://localhost:5173/leaderboards/2v2\">2v2 Arena Ladder</a>, <a href=\"http://localhost:5173/leaderboards/3v3\">3v3 Arena Ladder</a>"
